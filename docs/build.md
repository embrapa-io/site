...
- **PORT:** Utilizada para informar ao autômato de _deploy_ quais portas deverão ser expostas para a aplicação. Visando eliminar conflitos, a plataforma **Embrapa I/O** faz a gestão das portas atribuídas em cada _cluster_. Assim, ao selecionar uma variável deste tipo para a _build_ será atribuído um valor entre 49152 e 65535, que é a faixa de portas válidas utilizada pela plataforma.
