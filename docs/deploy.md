...
> **Atenção!** Antes de escolher o _cluster_ de destino, veja o capítulo sobre [publicação de aplicações]({{ site.baseurl }}/docs/delivery): ele orienta onde cada estágio da _build_ deve ser instanciado conforme o nível de serviço da infraestrutura.
