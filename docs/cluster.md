...
O processo de _build_ do Docker gera uma imensa quantidade de imagens e outros arquivos de _cache_. Isto tende a ocupar rapidamente todo o espaço em disco. Estes comandos garantem que este cache não tenha mais do que 24 horas.
